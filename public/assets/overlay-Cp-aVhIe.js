...
`,f=new e(`overlay`),p=null,m=null,h=null,g=null,_=null,v=null,y=null,b=null,x=null,S=!1,C=null,w=[],T=``,E={status:`idle`,latestVersion:``,error:``},D={onCheck:null,onOpen:null},O=n(a().overlayHotkey,o),k=[],A=null;const te2=`\n/* classic blue restoration */\n#gp-overlay{background:rgba(2,6,23,.86) !important;backdrop-filter:blur(18px) saturate(1.25);-webkit-backdrop-filter:blur(18px) saturate(1.25);width:min(820px,82vw) !important;min-width:480px}\n#gp-overlay .gp-btn{min-height:32px;font-size:12px;padding:6px 12px;background:rgba(74,158,255,.15);color:#4a9eff;border:1px solid rgba(74,158,255,.3);border-radius:8px;font-weight:600}\n#gp-overlay .gp-btn:hover{background:rgba(74,158,255,.28);border-color:rgba(74,158,255,.55);box-shadow:0 0 0 1px rgba(74,158,255,.25)}\n#gp-overlay .gp-btn:active{transform:translateY(1px)}\n#gp-overlay .gp-btn-danger{background:rgba(244,67,54,.14);color:#f44336;border-color:rgba(244,67,54,.35)}\n#gp-overlay .gp-btn-success{background:rgba(76,175,80,.14);color:#4caf50;border-color:rgba(76,175,80,.35)}\n#gp-overlay .gp-input,#gp-overlay select,#gp-overlay textarea{background:rgba(2,6,23,.6);border:1px solid rgba(74,158,255,.25);color:#dbeafe;border-radius:7px}\n#gp-overlay .gp-input:focus,#gp-overlay select:focus{border-color:rgba(74,158,255,.6);box-shadow:0 0 0 2px rgba(74,158,255,.18)}\n#gp-overlay .gp-toggle{background:rgba(255,255,255,.12)}\n#gp-overlay .gp-toggle.gp-toggle-on{background:rgba(74,158,255,.55)}\n#gp-overlay .gp-section{background:rgba(74,158,255,.05);border:1px solid rgba(74,158,255,.12)}\n#gp-overlay .gp-tab{color:#93c5fd}\n#gp-overlay .gp-tab.active{color:#fff;background:rgba(74,158,255,.22)}\n#gp-overlay .gp-header{border-bottom:1px solid rgba(74,158,255,.18)}\n#gp-overlay .gp-slider{accent-color:#4a9eff}\n#gp-overlay .gp-overlay-resizer{position:absolute;top:0;right:-4px;width:8px;height:100%;cursor:ew-resize;z-index:100000}\n#gp-overlay .gp-overlay-resizer::after{content:'';position:absolute;top:50%;right:2px;width:2px;height:56px;transform:translateY(-50%);background:rgba(148,163,184,.35);border-radius:2px}\n#gp-overlay.gp-resizing{transition:none !important;user-select:none !important}\n`;
